          ...
          <section className={styles.contactSection} aria-label="Contact form">
            ...
            <p className={styles.lead}>
              ...
              <ul className={styles.contactList}>
                <li>
                  ...
                  <span>вул. Промислова, 18<br />м. Луцьк, 43020, Україна</span>
                </li>
                <li>
                  ...
                  <a href="tel:+380632404221">+380 63 240 42 21</a>
                </li>
                <li>
            ...
            <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
              ...
              <fieldset className={styles.interest}>
                ...
                <label>
                  <input type="checkbox" name="interest" value="unsure" /> Я не впевнений
                </label>
              </fieldset>
