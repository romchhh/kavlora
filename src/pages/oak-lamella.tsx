...
import styles from "./OakLamella.module.css";
import { useI18n } from "@/hooks/useI18n";
import { useEffect, useRef, useState } from "react";
import { ContactModal } from "@/components/ContactModal";

export default function OakLamellaPage() {
  const { dict } = useI18n();
  const t = dict.productPages.oakLamella;
  ...
  useEffect(() => {
    const sectionConfigs = [
      {
        ref: introSectionRef,
        setInView: setIsIntroInView,
        threshold: 0.2,
      },
      {
        ref: gallerySectionRef,
        setInView: setIsGalleryInView,
        threshold: 0.2,
      },
      {
        ref: pointsSectionRef,
        setInView: setIsPointsInView,
        threshold: 0.2,
      },
      {
        ref: nextStepSectionRef,
        setInView: setIsNextStepInView,
        threshold: 0.25,
      },
    ];
  ...
  return (
    <div className={styles.page}>
      <Seo title={t.seoTitle} description={t.seoDescription} path="/oak-lamella" />
